...
%==========================================================================
Window = 10; % lagging moving average window size
...
% % Plot autocorrelation function of error between residual and residual estimator
% figure; 
%     plot(linspace(-length(zeroMeanErr),length(zeroMeanErr),length(zeroMeanErr)*2-1),xcorr(zeroMeanErr))
%     xlabel('Lags');
%     ylabel('Correlation');
%     title('Correlation function of residual estimator (should look like white noise)');


%==========================================================================
% Probably the most important plot - Are we making money yet?
%==========================================================================
figure;
    hold on
